                        ...
                        try {
                            ...
                            if (sent.equals(jsnObj.optString("sent"))) {
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(ForgotPasswordActivity.this, "E-mail Sent. Please check your e-mail.", Toast.LENGTH_LONG).show();
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(ForgotPasswordActivity.this, "This e-mail is not registered on BuyMe.", Toast.LENGTH_LONG).show();
                                ...
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(ForgotPasswordActivity.this, jsnObj.optString("error"), Toast.LENGTH_LONG).show();
                                    }
                                });
                            }
